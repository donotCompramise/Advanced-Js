const countries_data = [
 ...
 h1.innerHTML=`Worlds Countries Data`;
 h1.style.textAlign="center"

 
 var p1=document.getElementById("p1");
 p1.innerHTML=`Currently, we have 250 Countries`;
 ...
 population.innerHTML="most 10 population countries in the world"
 population.style.textAlign="center";


//  let div=document.getElementsByClassName("div-1")[0];
...
//  div.style.gap="10px"
 ...
 var maindiv=document.getElementsByClassName("name2")[0];
 maindiv.setAttribute("style","display:flex; justify-content:center; alignitems:center;margin-top:50px;gap:50px")

 var div1=document.getElementsByClassName("name")[0];
 var div2=document.getElementsByClassName("name1")[0];
 var div3=document.getElementsByClassName("name3")[0];

//  var input=div3.setAttribute("style","border:3px solid yellow;height:10px;width:100px;")
//  
var array=["world","world-1","world-2","world-3","world-4"];
var arr_count=[90,91,92,93,94];
...
var p4=document.createElement("p");
 p4.innerText=countries_data[i]['name'];
 
 div1.appendChild(p4);
 p4.style.gap="20px";

 var p3=document.createElement("p");
 p3.setAttribute("style","border:3px solid;height:30px;width:200px;diplay:flex;justify-content:space-between;")
 div3.appendChild(p3) ;

 var p2=document.createElement("p");
 p2.style.flexDirection="column"
 p2.innerText=countries_data[i]['population'];
 div2.appendChild(p2);
	 }
}
function languages(){
   ...
   var p4=document.createElement("p");
	p4.innerText=countries_data[i]['languages'];
	
	div1.appendChild(p4);
	p4.style.margin="30.5px";
   
   
	var p3=document.createElement("p");
	p3.setAttribute("style","border:3px solid;height:30px;width:300px;diplay:flex;justify-content:space-between;")
	div3.appendChild(p3) ;
	p3.style.margin="20px";
